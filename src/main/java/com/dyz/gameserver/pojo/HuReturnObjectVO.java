...
/**
 * 胡牌时返回信息组成对象 牌组，杠的详细信息，胡的详细信息，昵称，uuid
 * 
 * @author luck
 *
 */
public class HuReturnObjectVO {
	 ...
	 * 上几把牌的牌组
	 */
	private int[] beforePaiArray;
	

	public int[] getBeforePaiArray() {
		return beforePaiArray;
	}

	public void setBeforePaiArray(int[] beforePaiArray) {
		this.beforePaiArray = beforePaiArray;
	}
	...
	/**
	 * value:list里面，第一个为点炮/杠/胡次数，第二个元素为点炮/杠/胡分数总和 key:type:游戏自摸1，接炮2，点炮3，暗杠4，明杠5
	 * ，胡6记录(key),
	 */
	...
	public void setHuType(String huType) {
		if (huType.isEmpty()) {
			...
			this.huType = this.huType + " " + huType;
		}
	}
	 ...
	 * 
	 * @param type
	 *            信息类型 "chi","peng","gang","hu", 划水麻将跟庄"gengzhuang"
	 * @param str
	 *            信息内容
	 */
	...
	/**
	 * 游戏自摸1，接炮2，点炮3，暗杠4，明杠5 ，胡6记录(type),加码7 （点杠 8）
	 * 
	 * @param type
	 *            类型
	 * @param score
	...
	public synchronized void updateGangAndHuInfos(String type, int score) {
		...
		if (type.equals("4") || type.equals("5") || type.equals("8")) {
			// 杠的总分
